...
> 原文：[https://www.yuque.com/hollis666/asgng6/uv5yhtvvlff1np5q](https://www.yuque.com/hollis666/asgng6/uv5yhtvvlff1np5q)
> 
...
- http.request.uri，过滤指定http请求地址的数据包，如：http.request.uri matches '[baidu.com](http://baidu.com)'，注意matches是使用正则表达式模糊匹配

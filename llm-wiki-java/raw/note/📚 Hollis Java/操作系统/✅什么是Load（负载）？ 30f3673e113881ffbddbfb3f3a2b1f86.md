...
> 原文：[https://www.yuque.com/hollis666/asgng6/zmhkxcfgxc5ggz96](https://www.yuque.com/hollis666/asgng6/zmhkxcfgxc5ggz96)
> 
...
从上面的线程的栈日志中，可以发现，当前占用CPU较高的线程正在执行我代码的com.hollis.test.util.BeanValidator.validate([BeanValidator.java:30](http://BeanValidator.java:30))类。那么就可以去排查这个类是否用法有问题了。

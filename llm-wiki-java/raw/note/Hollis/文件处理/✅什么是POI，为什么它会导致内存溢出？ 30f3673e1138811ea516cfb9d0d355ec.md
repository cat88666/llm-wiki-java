...
> 原文：[https://www.yuque.com/hollis666/asgng6/gcxwx1gnimfyamvw](https://www.yuque.com/hollis666/asgng6/gcxwx1gnimfyamvw)
> 
...
所以，[如果我们把xlsx文件的后缀更改为.zip](http://如果我们把xlsx文件的后缀更改为.zip)或.rar，再进行解压缩，就能提取出构成Excel的核心源码文件。解压后会发现解压后的文件中有3个文件夹和1个XML格式文件：
...
[最终会调用到OPCPackage.open](http://最终会调用到OPCPackage.open)方法，看看这个方法是咋实现的：

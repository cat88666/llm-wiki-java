...
> 原文：[https://www.yuque.com/hollis666/asgng6/lwxtmggon7ir4zzz](https://www.yuque.com/hollis666/asgng6/lwxtmggon7ir4zzz)
> 
...
1. DEFAULT：如果不指定ALGORITHM，那么MySQL会自行选择默认算法，优先使用INSTANT、其次是INPLACE、再然后是COPY
...
| 操作 | 是否支持Inplace | 是否需要Copy Table | 是否允许并发DML | 是否允许并发查询 |
| --- | --- | --- | --- | --- |
| 创建普通索引 | 支持 | 不需要 | 允许 | 允许 |

...
> 原文：[https://www.yuque.com/hollis666/asgng6/lxb1s5pqizgaib0k](https://www.yuque.com/hollis666/asgng6/lxb1s5pqizgaib0k)
> 
...
但是，假设employees.department_[id和departments.id](http://id和departments.id) 都有索引的情况下，就不一样了，因为索引的查询是比较快的，他的复杂度是log(n)。那么：

...
> 原文：[https://www.yuque.com/hollis666/asgng6/pslhdo4g6i5h6gpg](https://www.yuque.com/hollis666/asgng6/pslhdo4g6i5h6gpg)
> 
...
- in之所以不需要关联条件，是因为在in的过程中其实就是在做关联条件的判断了，即用e.dept_[id和子查询中返回的d.id](http://id和子查询中返回的d.id)的结果集做值匹配。

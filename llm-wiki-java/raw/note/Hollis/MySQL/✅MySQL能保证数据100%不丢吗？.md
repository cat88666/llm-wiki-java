...
> 原文：[https://www.yuque.com/hollis666/asgng6/gb7rrfs70zli4mp8](https://www.yuque.com/hollis666/asgng6/gb7rrfs70zli4mp8)
> 
...
| --- | --- | --- | --- |
| 动作 | 写LogBufferwrite() 到 OS  Cachefsync() 到磁盘 | 写LogBuffer | 写 Log Bufferwrite() 到 OS Cache |
...
| --- | --- | --- | --- |
| 动作 | 写LogBufferwrite() 到 OS  Cachefsync() 到磁盘 | 写LogBuffer | 写LogBuffer每 N 个事务提交后，才将 binlog write() 到 Page Cache 并执行 fsync() 到刷盘。 |

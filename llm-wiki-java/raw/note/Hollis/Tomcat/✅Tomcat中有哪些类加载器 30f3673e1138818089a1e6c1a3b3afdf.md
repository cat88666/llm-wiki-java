...
> 原文：[https://www.yuque.com/hollis666/asgng6/rgupmyr7wo4s8zi0](https://www.yuque.com/hollis666/asgng6/rgupmyr7wo4s8zi0)
> 
...
但是，默认情况下，**Server类加载器和Shared类加载器是未定义的**，需要通过在conf/[catalina.properties](http://catalina.properties)中定义server.loader和/或shared.loader属性的值，才会是这个更复杂的层次结构。

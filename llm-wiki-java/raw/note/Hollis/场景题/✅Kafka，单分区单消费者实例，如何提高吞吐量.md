...
> 原文：[https://www.yuque.com/hollis666/asgng6/uwg9o64kxcyzrhyr](https://www.yuque.com/hollis666/asgng6/uwg9o64kxcyzrhyr)
> 
...
[num.network](http://num.network).threads 指定 Kafka Broker 用于处理网络请求的线程数，它主要负责处理来自客户端的请求、响应请求以及数据传输等。

[num.io](http://num.io).threads 指定 Kafka Broker 用于处理磁盘 I/O 的线程数，它主要负责读写磁盘上的数据。

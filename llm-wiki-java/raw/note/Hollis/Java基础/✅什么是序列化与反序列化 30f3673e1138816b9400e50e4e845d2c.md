...
> 原文：[https://www.yuque.com/hollis666/asgng6/rthz7lyvsfb3xvl4](https://www.yuque.com/hollis666/asgng6/rthz7lyvsfb3xvl4)
> 
...
在Java中，[只要一个类实现了java.io](http://只要一个类实现了java.io).Serializable接口，那么它就可以被序列化。这里先来一段代码：

code 2 对User进行序列化及反序列化的Demo：

以下几个和序列化&反序列化有关的知识点大家可以重点关注一下：

1、在Java中，[只要一个类实现了java.io](http://只要一个类实现了java.io).Serializable接口，那么它就可以被序列化。

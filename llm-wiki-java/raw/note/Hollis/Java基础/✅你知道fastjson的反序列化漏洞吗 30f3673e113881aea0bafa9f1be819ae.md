...
> 原文：[https://www.yuque.com/hollis666/asgng6/sexwwk](https://www.yuque.com/hollis666/asgng6/sexwwk)
> 
...
在fastjson中， 如果，[@type](https://www.notion.so/type )  指定的类为 Throwable 的子类，那对应的反序列化处理类就会使用到 ThrowableDeserializer 
...
设置了safeMode后，@type  字段不再生效，即当解析形如{"@type": "[com.java](http://com.java).class"}的JSON串时，将不再反序列化出对应的类。 

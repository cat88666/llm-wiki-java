...
> 原文：[https://www.yuque.com/hollis666/asgng6/bzmvmo4s1l8mig23](https://www.yuque.com/hollis666/asgng6/bzmvmo4s1l8mig23)
> 
...
这样，就实现了多态，同样是Parent类的实例，[p.call](http://p.call) 调用的是Son类的实现、[p1.call](http://p1.call)调用的是Daughter的实现。

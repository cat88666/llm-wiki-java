...
> 原文：[https://www.yuque.com/hollis666/asgng6/ub4syzfkylukv8xv](https://www.yuque.com/hollis666/asgng6/ub4syzfkylukv8xv)
> 
...
- [http://localhost:8081/user](http://localhost:8081/user)
- [http://localhost:8082/order](http://localhost:8082/order)

我们可以在注册中心注册一个 Zuul 服务，然后在 Zuul 服务中配置路由规则，将不同的请求路由给不同的服务：

这样，我们就可以通过访问 [http://localhost:8080/user/xxx](http://localhost:8080/user/xxx) 来访问 User Service，通过访问 [http://localhost:8080/order/xxx](http://localhost:8080/order/xxx) 来访问 Order Service 。

...
> 原文：[https://www.yuque.com/hollis666/asgng6/htrdnuwky10m81br](https://www.yuque.com/hollis666/asgng6/htrdnuwky10m81br)
> 
...
2. **语言支持不同**：Spring Cloud是基于Java语言实现的，同时也支持其他语言的开发，如Kotlin、Groovy、Scala等。而Dubbo则是一个纯Java实现的RPC框架，只支持Java语言开发（Dubbo-go框架支持go语言）。

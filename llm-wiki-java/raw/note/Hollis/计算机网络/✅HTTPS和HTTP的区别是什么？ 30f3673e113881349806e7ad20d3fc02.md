...
> 原文：[https://www.yuque.com/hollis666/asgng6/nixwqt](https://www.yuque.com/hollis666/asgng6/nixwqt)
> 
...
1. URL:
- HTTP: HTTP的URL以[http://开头](http://开头)
- HTTPS: HTTPS的URL以[https://开头](https://开头)
1. 证书:
- HTTP: HTTP不需要使用数字证书。

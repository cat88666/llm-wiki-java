...
> 原文：[https://www.yuque.com/hollis666/asgng6/chxc9y](https://www.yuque.com/hollis666/asgng6/chxc9y)
> 
...
首先就是可以将Session ID作为查询参数附加在URL中。例如，[http://www.hollischuang.com/page?sessionid=hollis666。服务器会解析URL中的Session](http://www.hollischuang.com/page?sessionid=hollis666。服务器会解析URL中的Session) ID，并使用它来识别和恢复用户的会话状态。这种方式在某些情况下可以工作，但也存在一些安全性和隐私方面的考虑。

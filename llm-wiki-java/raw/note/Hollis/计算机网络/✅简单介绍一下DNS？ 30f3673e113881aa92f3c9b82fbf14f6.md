...
> 原文：[https://www.yuque.com/hollis666/asgng6/oa7q69](https://www.yuque.com/hollis666/asgng6/oa7q69)
> 
...
例如，[wikipedia.org](http://wikipedia.org)是一个域名，和IP地址208.80.152.2相对应。[人们可以直接访问wikipedia.org](http://人们可以直接访问wikipedia.org)来代替IP地址，然后域名系统（DNS）就会将它转化成便于机器识别的IP地址。

这样，[人们只需要记忆wikipedia.org](http://人们只需要记忆wikipedia.org)这一串带有特殊含义的字符，而不需要记忆没有含义的数字。
...
然后，本地DNS解析器将向**顶级域名服务器**发送请求，顶级域名服务器是负责特定顶级域（[如.com](http://如.com)、.org、.net等）的服务器。顶级域名服务器会告诉本地DNS解析器该域名对应的权威域名服务器。

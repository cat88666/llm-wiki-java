...
> 原文：[https://www.yuque.com/hollis666/asgng6/nl3dfw](https://www.yuque.com/hollis666/asgng6/nl3dfw)
> 
...
]([https://www.hollischuang.com/archives/3928](https://www.hollischuang.com/archives/3928))
...
Step1 ,Thread1执行到第8行，开始进行对象的初始化。 Step2 ,Thread2执行到第5行，判断singleton == null。 Step3 ,Thread2经过判断发现singleton ！= null，所以执行第12行，返回singleton。 Step4 ,Thread2拿到singleton对象之后，开始执行后续的操作，[比如调用singleton.call](http://比如调用singleton.call)()。

以上过程，看上去并没有什么问题，但是，其实，在Step4，[Thread2在调用singleton.call](http://Thread2在调用singleton.call)()的时候，是有可能抛出空指针异常的。

...
> 原文：[https://www.yuque.com/hollis666/asgng6/kanfbagntpcyqc0c](https://www.yuque.com/hollis666/asgng6/kanfbagntpcyqc0c)
> 
...
1. 激活 Profile：可以通过多种方式激活 Profile，如设置环境变量、JVM 参数、Web 应用的上下文参数或在 [application.properties](http://application.properties) 文件中使用 spring.profiles.active 属性。

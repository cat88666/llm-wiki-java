...
> 原文：[https://www.yuque.com/hollis666/asgng6/ikdbgt9mpm46u298](https://www.yuque.com/hollis666/asgng6/ikdbgt9mpm46u298)
> 
...
为了解决这个问题，我们采用多线程扫表的方案，这里基于 XXL-JOB 的分片功能，充分利用集群中的所有实例进行任务处理，并且在每个任务的执行过程中，采用生产者消费者模式，在基于线程池进行快速消费。本文介绍 XXL-JOB 的分片任务。（整体方案见[数藏项目](https://www.yuque.com/hollis666/asgng6/dgolk0cckpb94sia)）

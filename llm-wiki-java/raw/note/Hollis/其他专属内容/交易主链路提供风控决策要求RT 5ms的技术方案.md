...
> 原文：[https://www.yuque.com/hollis666/asgng6/hpspveeinpub4o1t](https://www.yuque.com/hollis666/asgng6/hpspveeinpub4o1t)
> 
...
直接把当日分区中的所有数据，直接刷入到Tair中，value为N时会自动删除数据
...
基于JSONPath进行参数解析，在配置文件中只需要配置参数读取的路径即可，如$.buyerId 、 $.[extendInfo.phone](http://extendInfo.phone)等。
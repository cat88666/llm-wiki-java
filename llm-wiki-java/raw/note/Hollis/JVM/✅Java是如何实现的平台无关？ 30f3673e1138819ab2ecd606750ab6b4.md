...
> 原文：[https://www.yuque.com/hollis666/asgng6/wgcs7a](https://www.yuque.com/hollis666/asgng6/wgcs7a)
> 
...
前端编译主要指与源语言有关但与目标机无关的部分。Java中，我们所熟知的javac的编译就是前端编译。除了这种以外，我们使用的很多IDE，如eclipse，idea等，都内置了前端编译器。[主要功能就是把.java](http://主要功能就是把.java)代码转换成.class代码。

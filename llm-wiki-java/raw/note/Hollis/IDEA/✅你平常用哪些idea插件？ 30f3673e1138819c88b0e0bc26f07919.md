...
> 原文：[https://www.yuque.com/hollis666/asgng6/vxmblxpk6mmqesn4](https://www.yuque.com/hollis666/asgng6/vxmblxpk6mmqesn4)
> 
...
- 文本转换操作
- 切换样式（camelCase, hyphen-lowercase, HYPHEN-UPPERCASE, snake_case, SCREAMING_SNAKE_CASE, [dot.case](http://dot.case), words lowercase, Words Capitalized, PascalCase）
- 转换为SCREAMING_SNAKE_CASE (或转换为camelCase)
- 转换为 snake_case (或转换为camelCase)
- [转换为dot.case](http://转换为dot.case) (或转换为camelCase)

...
| [四、核心组件](#四核心组件) | EventLoopGroup、ChannelPipeline、ByteBuf |
| [五、粘包拆包解决方案](#五粘包拆包解决方案) | 3种解码器 + 生产首选 |
| [六、心跳机制](#六心跳机制) | IdleStateHandler 检测 + 应用层心跳 |
| [七、TCP 参数调优](#七tcp-参数调优) | SO_BACKLOG、TCP_NODELAY、WriteBufferWaterMark |
| [八、高性能设计要点](#八高性能设计要点) | 无锁串行化、内存池、零拷贝、epoll ET |
| [九、关键权衡](#九关键权衡) | EventLoop 单线程 vs 耗时操作，ByteBuf 手动释放 |
| [十、与其他概念的关系](#十与其他概念的关系) | IO模型、Dubbo、设计模式 |

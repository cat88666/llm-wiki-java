...
| 标题索引 | 概述 |
| --- | --- |
| [一、RocketMQ 补齐的消息能力](#一rocketmq-补齐的消息能力) | Kafka 的缺失能力，支付场景的需求 |
...
| [十一、RocketMQ 事务取舍](#十一rocketmq-事务取舍) | 事务消息 vs 本地消息表 |
| [十二、RocketMQ 的生态位置](#十二rocketmq-的生态位置) | Kafka、RabbitMQ、幂等设计、Seata |
| [十三、RocketMQ 适用边界](#十三rocketmq-适用边界) | 适合 vs 不适合场景 |

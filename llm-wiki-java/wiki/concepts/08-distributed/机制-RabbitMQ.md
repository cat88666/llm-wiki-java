...
| 标题索引 | 概述 |
| --- | --- |
| [一、Exchange 路由模型解决什么](#一exchange-路由模型解决什么) | 生产消费解耦、路由 Exchange 核心思想 |
...
| [九、RabbitMQ 可靠性取舍](#九rabbitmq-可靠性取舍) | Confirm vs 事务、持久化 vs 性能 |
| [十、RabbitMQ 的生态位置](#十rabbitmq-的生态位置) | Kafka、幂等设计、Redis |
| [十一、RabbitMQ 适用边界](#十一rabbitmq-适用边界) | 适合 vs 不适合场景 |

...
| 标题索引 | 概述 |
| --- | --- |
| [一、集合框架本质](#sec-2) | 数组不够用、统一数据容器抽象 |
| [二、数据结构全景](#sec-3) | 线性/树/堆/图/BitMap 知识地图 |
| [三、集合体系总结](#sec-4) | Collection / Map / 并发容器类层次全景 |
| [四、List体系](#sec-5) | ArrayList、LinkedList、CopyOnWriteArrayList |
| [五、Set体系](#sec-6) | HashSet、LinkedHashSet、TreeSet、去重与排序 |
| [六、Map体系](#sec-7) | HashMap、LinkedHashMap、TreeMap、ConcurrentHashMap |
| [七、Queue体系](#sec-8) | ArrayDeque、PriorityQueue、BlockingQueue |
| [八、HashMap 原理](#sec-9) | 数据结构、扰动函数、扩容机制 |
| [九、ConcurrentHashMap 原理](#sec-10) | JDK7 分段锁、JDK8 CAS + 节点锁 |
| [十、CopyOnWriteArrayList 原理](#sec-11) | 写时复制、快照迭代、适用边界 |
| [十一、线性结构基础](#sec-12) | 数组、链表、栈、队列选型 |
| [十二、综合对比](#sec-13) | List/Set/Map/Queue 横向对比 |
| [十三、生产风险](#sec-14) | 常见误区与踩坑 |
| [十四、应用边界](#sec-15) | 并行流、并发容器边界 |
| [十五、核心总结](#sec-16) | 高频考点：红黑树/B+树/堆/跳表/图/BitMap |

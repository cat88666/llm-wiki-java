...
| 标题索引 | 概述 |
| --- | --- |
| [一、序列化要解决的本质问题](#sec-2) | 跨进程与跨时间保存对象状态 |
| [二、Java 原生序列化机制链路](#sec-3) | Serializable、ObjectStream、对象图编码 |
| [三、serialVersionUID 与类演进兼容](#sec-4) | UID 校验机制与变更策略 |
| [四、字段规则与自定义钩子](#sec-5) | transient、writeObject/readObject、readResolve |
| [五、协议选型与场景匹配](#sec-6) | JDK/JSON/Protobuf/Hessian/Kryo 对比 |
| [六、生产风险与防御策略](#sec-7) | 反序列化漏洞、兼容事故、性能问题 |
| [七、实战排障与迁移思路](#sec-8) | InvalidClassException、协议切换、灰度 |
| [八、关系图与边界](#sec-9) | 与异常、RPC、缓存、类加载的关系 |
| [九、面试速答口径](#sec-10) | 高频问题的可直接复述答案 |

...
| 标题索引 | 概述 |
| --- | --- |
| [一、类型设计的核心矛盾](#sec-2) | 性能、可用性与语义安全平衡 |
| [二、String 不可变机制](#sec-3) | 常量池、hash 稳定性、线程安全 |
| [三、包装类与装箱拆箱](#sec-4) | 对象化需求与缓存机制 |
| [四、BigDecimal 精度模型](#sec-5) | 十进制精确运算规则 |
| [五、编码选型原则](#sec-6) | String/Builder、基本类型/包装类选择 |
| [六、对比与结论](#sec-7) | 常见类型方案对比 |
| [七、生产风险与排查](#sec-8) | 拆箱 NPE、`==` 陷阱、精度事故 |
| [八、关系与边界](#sec-9) | 与泛型、JMM、集合关系 |

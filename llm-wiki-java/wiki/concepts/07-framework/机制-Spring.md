...
| [二、核心机制——IoC 容器](#二核心机制ioc-容器) | BeanDefinition、生命周期、作用域、三级缓存、循环依赖 |
| [三、核心机制——AOP 织入](#三核心机制aop-织入) | 术语、代理实现、五种 Advice、失效场景 |
| [四、核心机制——声明式事务](#四核心机制声明式事务) | @Transactional 原理、事务传播、事务失效 |
| [五、关键权衡](#五关键权衡) | 线程安全、循环依赖、调试、事务边界 |
| [六、与其他概念的关系](#六与其他概念的关系) | 动态代理、SpringBoot、SpringMVC、ThreadLocal、MVCC |
| [七、应用边界](#七应用边界) | 适合 / 不适合容器管理、适合 / 不适合 @Transactional |
